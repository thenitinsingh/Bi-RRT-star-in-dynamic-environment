...
display_results(original_obstacles, effective_obstacles_original, path_original, all_paths_original, distance_original,
                "With Original Obstacles")
# Shift obstacles
...
display_results(shifted_obstacles, effective_obstacles_shifted, path_shifted, all_paths_shifted, distance_shifted,
                "With Shifted Obstacles")
# Show both plots
plt.show()